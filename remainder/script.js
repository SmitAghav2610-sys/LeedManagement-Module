...
function createProposal() {
  ...
  if (selectedLeads.length > 1) {
    ...
    alert("Please select only one lead to create a proposal.")
    ...
    if (selectedLeadDetails) {
      ...
      alert(`Creating proposal for ${leadName}. This would redirect to the proposal page.`)
    ...
    alert("Please select a lead to create a proposal.")
  }
}
